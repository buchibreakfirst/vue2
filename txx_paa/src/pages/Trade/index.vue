  ...
  export default {
    ...
    methods:{
      ...
      async submitOrder(){
        ...
        //其余的6个参数
        let data = {
          consignee:this.userDefaultAdress.consignee,  //收件人名字
          consigneeTel:this.userDefaultAdress.phoneNum, //手机号
          deliveryAddress:this.userDefaultAdress.fullAddress,//地址
          paymentWay:'ONLINE',//支付方式
          orderComment:this.userDefaultAdress.msg,//买家留言信息
