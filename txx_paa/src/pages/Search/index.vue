    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="details clearfix">
            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{active:isOne}" @click="changeOrder(1)">
                  <a>综合<span v-show="isOne">{{ Arrow }}</span></a>
                </li>
                <li :class="{active:isTwo}" @click="changeOrder(2)">
                  <a>价格<span v-show="isTwo">{{ Arrow }}</span></a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <!-- 分页器 -->
          <Pagination :pageNo="searchParams.pageNo" :pageSize="searchParams.pageSize" :total="total" :continues="5" @getPagNo="getPagNo"/>
        </div>
      </div>
    </div>
  </div>
    ...
    watch:{
      ...
      $route:{
        ...
        handler(newVaule,oldValue){
          //每一次请求完毕，应该把周期的1，，2，3级分类的id置空，让他接受下一次的
